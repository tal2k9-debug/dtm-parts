  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 top-1/2 -translate-y-1/2 z-50 bg-blue-700 hover:bg-blue-800 text-white w-8 h-8 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300"
