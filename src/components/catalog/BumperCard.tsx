          ...
          <div className="relative aspect-[4/3] bg-gray-100 overflow-hidden">
            ...
            <div className="absolute bottom-3 left-3 flex gap-2">
              ...
              <a
                ...
                className="w-6 h-6 rounded-full bg-[#25D366] flex items-center justify-center hover:bg-[#20bd5a] transition-colors duration-200 shadow-md"
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={(e) => e.stopPropagation()}
                className="w-6 h-6 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center hover:bg-white transition-colors duration-200 shadow-md"
                aria-label="שתף עם חבר"
                title="שתף עם חבר"
              >
                <svg className="w-3 h-3 text-[#25D366]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
