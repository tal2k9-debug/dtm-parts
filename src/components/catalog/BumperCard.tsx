        ...
        <div className="group bg-surface rounded-2xl border border-border overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="relative aspect-[4/3] bg-gray-100 overflow-hidden">
            ...
            <a
              ...
              className="absolute bottom-3 left-3 w-9 h-9 rounded-full bg-[#25D366] flex items-center justify-center hover:bg-[#20bd5a] transition-colors duration-200 shadow-md"
